...
class Static(Mode):
    ...
    def check_Wireless_Security(self):
        ...
        if self.Settings.WSLayout.isChecked():
            ...
            self.FSettings.Settings.set_setting('accesspoint','WPA_SharedKey',self.Settings.editPasswordAP.text())
            self.FSettings.Settings.set_setting('accesspoint','WPA_Algorithms',self.Settings.wpa_pairwiseCB.currentText())
            self.FSettings.Settings.set_setting('accesspoint','WPA_type',self.Settings.WPAtype_spinbox.value())
